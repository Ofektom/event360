      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <header className="mb-16">
          ...
          <p className="text-xl text-gray-600">
            Your complete event management platform for celebrations, weddings, and special moments
          </p>
        </header>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-gray-600">
              Start planning your celebration with multiple ceremonies, guest management, and more
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600">
              View and manage all your events, ceremonies, and guest lists
            </p>
          </Link>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="p-6 bg-white rounded-xl shadow-md">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">Multiple Ceremonies</h3>
        ...
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 text-white">
          ...
          <p className="mb-6 text-purple-100">
            Create your first event and start planning your celebration today
          </p>
          <Link
            href="/events/new"
